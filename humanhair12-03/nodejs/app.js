...
app.post("/addProduct", upload.fields([
  ...
  { name: 'roomVideo', maxCount: 1 } // Added for video
]), async (req, res) => {
  let { vendorId, name, slug, location, description, active, price, noBathroom, noBedroom, overallSize, floorSpace, category, subcategory } = req.body;
